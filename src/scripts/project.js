    ...
    for (i = 0; i < result.setup.features.length; i ++) {
        ...
        if (result.setup.features[i] === 'todolist') {
            ...
            if (result.AIsetup === false) {
                ...
                <input type="text" id="user-ai-input" onkeydown="userInputAI(event)" placeholder="Talk with ProjectAI">
